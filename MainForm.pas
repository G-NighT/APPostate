...
begin
  ...
  if buttonSelected = mrYes then                                                // Обработка случая, когда пользователь нажимает "Yes"
    begin
      ...
      Application.Terminate;                                                    // Уничтожение приложения
      TrimWorkingSet;                                                           // Очистка всех переменных в оперативной памяти
    end;

  if buttonSelected = mrNo then                                                 // Обработка случая, когда пользователь нажимает "No"
    begin
      Application.Terminate;                                                    // Уничтожение приложения
      TrimWorkingSet;                                                           // Очистка всех переменных в оперативной памяти
    end;
